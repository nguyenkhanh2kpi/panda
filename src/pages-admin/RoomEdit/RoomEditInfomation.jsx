...
export const RoomEditInfomation = () => {
    ...
    useEffect(() => {
        interviewService
            ...
            .then((res) => {
                setRoom(res);
                const interviewerEmails = res.listInterviewer.map(
                    (interviewer) => interviewer.email
                );
                const candidateEmails = res.listCandidate.map(
                            ...
                            <HStack h={"100%"}>
                                ...
                                <VStack h={"100%"} w={"82%"} p={2}>
                                    ...
                                    >
                                        ...
                                        >
                                            {room.listCandidate &&
                                            Array.isArray(room.listCandidate)
                                                ? room.listCandidate.length
                                                : 0}{" "}
                                            Addtendee
                                        </Button>
                                        <Wrap ml={20}>
                                            {room.listCandidate.map(
                                                (candidate) => (
