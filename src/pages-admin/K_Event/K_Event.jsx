...
import { Button, IconButton, Skeleton, Spinner, Stack, Text } from '@chakra-ui/react'
          ...
          <div className='mt-24'>
            <div className='flex flex-wrap'>
              {events
                ...
                .map((event) => (
                  <div key={event.id} className='w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3'>
